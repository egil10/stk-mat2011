...
Usage:
    python code/scripts/p_hist.py              # process all
    python code/scripts/p_hist.py --symbol EURUSD   # process one symbol
    python code/scripts/p_hist.py --dry-run     # preview without writing
"""
